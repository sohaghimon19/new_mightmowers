...
<body>
  <div class="main-wrap" style="padding-bottom: 40px;">
    ...
    <div class="main_body" id="contact_body">
      <div id="contactleft">
        <h1>Contact Us</h1><br/>
        <form action="contact_process.php" name="contactForm" method="post" onsubmit="return validateForm()">
          <div id="c1"> Name: <span>*</span>
            <input id="name" name="name" type="text" class="border" onfocus="this.className='border1';"  onblur="this.className='border';" />
            Address:
            <input id="address" name="address" type="text" class="border" onfocus="this.className='border1';"   onblur="this.className='border';" />
            City: <span>*</span>
            <input id="city" name="city" type="text" class="border" onfocus="this.className='border1';"
             onblur="this.className='border';" />
            Phone:
            <input id="telephone" name="telephone" type="text" class="border" onfocus="this.className='border1';"
             onblur="this.className='border';" />
            E-mail:<span>*</span>
